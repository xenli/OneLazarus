...
type
  ...
  IDemoCustResultController = interface
    ...
    function GetResultList(): TActionResult<TListTStr>;
    // 返回结果格式 {ResultBool: false, ResultCode: "0002", ResultMsg: "", ResultData: [{name: "范联满", age: 10},{name: "范联满", age: 10}]}
    function GetResultListPerson(): TActionResult<TListTPerSon>;
    // 返回结果格式 {ResultBool: false, ResultCode: "0002", ResultMsg: "", ResultData: [{name: "范联满", age: 10},{name: "范联满", age: 10}]}
...
function TDemoCustResultController.GetResultList(): TActionResult<TListTStr>;
var
  i: integer;
  lList: TList<string>;
begin
  ...
  Result := TActionResult<TListTStr>.Create(True, False);
...
function TDemoCustResultController.GetResultListPerson(): TActionResult<TListTPerSon>;
var
  i: integer;
...
begin
  ...
  Result := TActionResult<TListTPerSon>.Create(True, True);
