...
begin
  ...
  if lMethodName = 'OneGetHelloWorld' then
  begin
    self.OneGetHelloWorld(THTTPCtxt(aArgs[0].AsObject), THTTPResult(aArgs[1].AsObject));
  end
  else
...
procedure TDemoController.OneGetHelloWorld(QHTTPCtxt: THTTPCtxt;
