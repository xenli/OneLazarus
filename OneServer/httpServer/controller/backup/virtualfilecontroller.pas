...
type
  ...
  IOneVirtualFileController = interface
    ...
    function GetTaskID(QVirtualTask: TVirtualTask): TActionResultT<TVirtualTask>;
...
function TOneVirtualFileController.GetTaskID(QVirtualTask: TVirtualTask): TActionResultT<
TVirtualTask>;
var
  ...
  lFileStream: TFileStream;
begin
  Result := TActionResultT<TVirtualTask>.Create(True, False);
