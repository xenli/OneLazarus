...
type
  ...
  public
    constructor Create(QEventWorkSend: EventOneWorkSend = nil; QEventOneWork: EventOneWork = nil);
...
constructor TOneTimerThread.Create(QEventWorkSend: EventOneWorkSend = nil; QEventOneWork: EventOneWork = nil);
var
  ii: TGUID;
begin
...
constructor TOneSingleWorkThread.Create(QEventWorkSend: EventOneWorkSend = nil; QEventOneWork: EventOneWork = nil);
var
  ii: TGUID;
begin
  inherited Create(True);
