...
type
  ...
  IDemoZTController = interface
    ...
    function GetData(): TActionResultT<TBufDataSet>;
...
function TDemoZTController.GetData(): TActionResultT<TBufDataSet>;
var
  i: integer;
...
begin
  ...
  Result := TActionResultT<TBufDataSet>.Create(True, True);
