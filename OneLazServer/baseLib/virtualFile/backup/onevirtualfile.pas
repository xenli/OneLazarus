...
uses
  Generics.Collections, StrUtils, SysUtils, DateUtils, OneThread,
  SyncObjs, OneSerialization;
...
type
  ...
  published
    ...
    property VirtualSetList: TList<TOneVirtualItem>
      read FVirtualSetList write FVirtualSetList;
  end;
  ...
  published
    property VirtualList: TDictionary<string, TOneVirtualItem>
      read FVirtualList write FVirtualList;
  end;
...
begin
  ...
  //注册序列化rtti信息
  OneSerialization.AddListClass(TList<TOneVirtualItem>, TOneVirtualItem, nil);
end;
...
function TOneVirtualManage.GetVirtual(QVirtualCode: string;
  var QErrMsg: string): TOneVirtualItem;
var
  lVirtualItem: TOneVirtualItem;
  lKey: string;
begin
...
function TOneVirtualManage.GetVirtualPhy(QVirtualCode: string;
  var QErrMsg: string): string;
var
  lVirtualItem: TOneVirtualItem;
  lKey: string;
begin
