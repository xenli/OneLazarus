...
var
  ...
  lErrMsg: string;
  lActionResult: TActionResultT<TClientConnect>;
begin
  Result := False;
  ...
  lResulTJsonData := nil;
  lActionResult := TActionResultT<TClientConnect>.Create;
...
var
  lPosTJsonData, lResulTJsonData: TJsonData;
  lActionResult: TActionResultT<TVirtualTask>;
  tempMsg: string;
...
begin
  ...
  lResulTJsonData := nil;
  lPosTJsonData := nil;
  lActionResult := TActionResultT<TVirtualTask>.Create;
